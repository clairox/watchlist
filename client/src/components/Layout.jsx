...
export const Layout = () => {
    ...
    return (
        <div>
            ...
            <nav className={`transform fixed top-0 left-0 bg-gray-700 w-72 h-full overflow-auto ease-in-out transition-all duration-300 z-50 text-gray-100 drop-shadow-lg lg:hidden ${sideMenuOpen ? 'translate-x-0' : '-translate-x-full'}`} >
